...
const Form = () => {
  ...
  const [isToggledToPassword, setIsToggledToPassword] = useState(true);
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <TextField
              label="Password"
              type={isToggledToPassword ? "password" : "text"}
              onBlur={handleBlur}
              onChange={handleChange}
              ...
              InputProps={{
                endAdornment: (
                  <RemoveRedEyeOutlinedIcon
                    onClick={() => setIsToggledToPassword(!isToggledToPassword)}
                    sx={{ "&:hover": { cursor: "pointer" } }}
                  />
                ),
              }}
